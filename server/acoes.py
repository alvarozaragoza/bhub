def GUIA_REMESSA(pv_id, prod_id):
    # CODIFICAR OS PASSOS DA AÇÃO aqui
    print(f"Executando ação GUIA_REMESSA com pedido: {pv_id} e produto: {prod_id}")
 
def GUIA_ROYALTIES(pv_id, prod_id):
    # CODIFICAR OS PASSOS DA AÇÃO AQUI
    print(f"Executando ação GUIA_ROYALTIES com pedido: {pv_id} e produto: {prod_id}")
 
def PGTO_COMISSAO(pv_id, prod_id):
    # CODIFICAR OS PASSOS DA AÇÃO AQUI
